...
function loadWidget(config) {
	...
	setTimeout(() => {
		document.getElementById("waifu").style.bottom = 80 +'px';
    document.getElementById("waifu").style.right = 20 + 'px';
...
function initWidget(config, apiPath = "/") {
  ...
  <div class=" hide-live2d no-select" id="show_model"><div class="keys">Hide</div></div>
		<div class=" live2d-pio no-select" id="switch_live2d"><div class="keys">Switch</div></div>
		<div id="switch_model"><!--class=" switch-live2d no-select" <div class="keys">Switch</div>--></div>
		<div class=" save-live2d no-select" id="save_pic"><div class="keys">Save</div></div>
		</div>`);
